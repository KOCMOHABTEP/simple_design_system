            ...
            <div className={styles.bannerBody}>
                ...
                <div className={styles.bannerBodyUser}>
                    ...
                    <div className={styles.bannerBodyUserInfo}>
                        ...
                        <div className={styles.userMembership}>Пользователь с 09 Окт 2021</div>
                        <div className={styles.userSocials}>
                            <Link href="https://steamcommunity.com/id/KOCMOHABTYC" passHref>
                                <a className={styles.userSocialsLink}>
                                    <div className={styles.userSocialsItem}>
                                        <div className={styles.userSocialsItemIcon}>
                                            <Icon name="social-steam" size={24} />
                                        </div>
                                        <div className={styles.userSocialsItemName}>KOCMOHABT</div>
                                    </div>    
                                </a>
                            </Link>
                        </div>
